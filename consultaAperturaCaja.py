...
class consultaVentasDia(QMainWindow):
    def __init__(self):
        ...
        uic.loadUi("gui/consultaAperturaCaja.ui",self)
        self.setWindowTitle("Consulta apertura de caja y cierres de caja")
        self.setWindowIcon(QIcon("Qt.png"))
        self.statusBar().showMessage("Visualizar, imprimir y exportar datos a PDF sobre las Apertura de Caja")
        ...
        self.treeWidgetVentas.setHeaderLabels(("IDUSUARIO", "FECHA", "MONTO APERTURA", "MONTO CIERRE"))
  ...
  #==============================================================
    ...
    def Buscar(self):
        ...
        print(fechaDesde)
        print(fechaHasta)
        cursor.execute("SELECT idUsuario, fecha, montoInicial, montoFinal FROM caja WHERE fecha BETWEEN %s AND %s ORDER BY fecha ASC ; ", (fechaDesde,fechaHasta))
